...
export function EducationalPanel({
  ...
  mistakes,
  cpTips,
  reference = "CP-Algorithms reference guide",
      ...
      <CardHeader className="pb-2 border-b border-border/10">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-3 max-w-md">
            ...
            <TabsTrigger value="math" className="cursor-pointer text-xs flex items-center gap-1">
        ...
        {activeTab === "math" && (
          <div className="space-y-4 text-xs text-left">
            ...
            <div>
              ...
              <p className="text-foreground/80 leading-relaxed font-sans">{example}</p>
            </div>
          </div>
        )}
