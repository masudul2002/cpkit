          ...
          <Card className="border-border/40 shadow-xs">
            ...
            <CardContent className="pt-4 space-y-4">
              {examples.map((ex, idx) => (
                <div
                  key={idx}
                  onClick={() => onSelectExample && onSelectExample(ex.input)}
                ...
                >
                  ...
                  <div className="space-y-1 font-mono text-[10px]">
                    <div className="flex gap-2">
                      <span className="text-muted-foreground uppercase text-[9px] w-12 shrink-0">Input:</span>
                      <span className="text-foreground break-all">{ex.input}</span>
                    </div>
                    <div className="flex gap-2">
                      <span className="text-muted-foreground uppercase text-[9px] w-12 shrink-0">Output:</span>
                      <span className="text-primary font-bold break-all">{ex.output}</span>
                    </div>
                  </div>
                  {onSelectExample && (
