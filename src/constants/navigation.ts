...
export const sidebarItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: Coins,
    children: [
      { title: "Activity Selection", href: "/greedy/activity-selection", icon: Activity },
      { title: "Fractional Knapsack", href: "/greedy/fractional-knapsack", icon: Layers },
      { title: "Job Sequencing", href: "/greedy/job-sequencing", icon: Sliders },
      { title: "Minimum Platforms", href: "/greedy/minimum-platform", icon: Compass },
      { title: "Interval Scheduling", href: "/greedy/interval-scheduling", icon: TrendingUp },
      { title: "Merge Intervals", href: "/greedy/interval-merging", icon: Scissors },
      { title: "Huffman Coding", href: "/greedy/huffman", icon: Calculator },
      { title: "Coin Greedy", href: "/greedy/coin-greedy", icon: Sliders },
      { title: "Gas Station", href: "/greedy/gas-station", icon: Compass },
      { title: "Optimal Merge", href: "/greedy/optimal-merge", icon: Calculator },
      { title: "Load Balancing", href: "/greedy/load-balancing", icon: Cpu },
    ],
  },
  {
    title: "Geometry",
    ...
    icon: Triangle,
    children: [
      { title: "Point Distance", href: "/geometry/point", icon: Activity },
      { title: "Orientation Test", href: "/geometry/orientation", icon: Layers },
      { title: "Vector Cross Product", href: "/geometry/cross-product", icon: Sliders },
      { title: "Vector Dot Product", href: "/geometry/dot-product", icon: Sliders },
      { title: "Line Intersection", href: "/geometry/line-intersection", icon: Compass },
      { title: "Convex Hull", href: "/geometry/convex-hull", icon: Scissors },
      { title: "Polygon Properties", href: "/geometry/polygon", icon: Calculator },
      { title: "Circle Properties", href: "/geometry/circle", icon: Calculator },
      { title: "Triangle Properties", href: "/geometry/triangle", icon: Calculator },
      { title: "Point in Polygon", href: "/geometry/point-in-polygon", icon: Scissors },
      { title: "Closest Pair", href: "/geometry/closest-pair", icon: Compass },
      { title: "Coordinate Transform", href: "/geometry/coordinate-transform", icon: Cpu },
    ],
  },
  {
    ...
    icon: Search,
    children: [
      { title: "Linear Search", href: "/search/linear-search", icon: Activity },
      { title: "Binary Search", href: "/search/binary-search", icon: Layers },
      { title: "Lower Bound", href: "/search/lower-bound", icon: Compass },
      { title: "Upper Bound", href: "/search/upper-bound", icon: Compass },
      { title: "Ternary Search", href: "/search/ternary-search", icon: TrendingUp },
      { title: "Search on Answer", href: "/search/binary-search-answer", icon: Calculator },
      { title: "Bubble Sort", href: "/sorting/bubble-sort", icon: Sliders },
      { title: "Selection Sort", href: "/sorting/selection-sort", icon: Sliders },
      { title: "Insertion Sort", href: "/sorting/insertion-sort", icon: Sliders },
      { title: "Merge Sort", href: "/sorting/merge-sort", icon: Layers },
      { title: "Quick Sort", href: "/sorting/quick-sort", icon: Scissors },
      { title: "Heap Sort", href: "/sorting/heap-sort", icon: Calculator },
      { title: "Counting Sort", href: "/sorting/counting-sort", icon: Cpu },
      { title: "Radix Sort", href: "/sorting/radix-sort", icon: Cpu },
      { title: "Bucket Sort", href: "/sorting/bucket-sort", icon: Cpu },
      { title: "Sort Benchmark", href: "/sorting/sort-benchmark", icon: Calculator },
