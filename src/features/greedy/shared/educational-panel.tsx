...
export function EducationalPanel({
  ...
  mistakes,
  cpTips,
  reference = "CP-Algorithms greedy reference",
      ...
      <CardContent className="p-6">
        {activeTab === "info" && (
          <div className="space-y-4 text-xs text-left">
            ...
            <div>
              ...
              <p className="text-foreground/80 leading-relaxed">{greedyChoice}</p>
            </div>
            <div>
              <span className="font-bold text-foreground uppercase tracking-wider text-[10px] text-muted-foreground block mb-1">
                Optimal Substructure
              </span>
              <p className="text-foreground/80 leading-relaxed">{optimalSubstructure}</p>
            </div>
            <div>
              <span className="font-bold text-foreground uppercase tracking-wider text-[10px] text-muted-foreground block mb-1">
                Proof Idea / Correction
              </span>
              <p className="text-foreground/80 leading-relaxed">{proofIdea}</p>
            </div>
            {reference && (
        ...
        {activeTab === "code" && (
          <div className="space-y-4 text-xs text-left">
            <div>
              <span className="font-bold text-foreground uppercase tracking-wider text-[10px] text-muted-foreground block mb-1">
                Greedy Simulation Code (Pseudocode)
              </span>
