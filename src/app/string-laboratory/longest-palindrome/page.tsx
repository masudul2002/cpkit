...
import { LongestPalindromeTool } from "@/features/string-laboratory/tools/longest-palindrome/longest-palindrome-tool";
import Link from "next/link";
import { Button } from "@/components/ui/button";
import { ArrowLeft } from "lucide-react";

export default function LongestPalindromePage() {
  return (
