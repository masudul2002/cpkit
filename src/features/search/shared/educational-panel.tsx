...
export function EducationalPanel({
  ...
  mistakes,
  cpTips,
  reference = "CP-Algorithms search & sorting reference",
        ...
        {activeTab === "info" && (
          <div className="space-y-4 text-xs text-left">
            ...
            <div>
              ...
              <p className="text-foreground/80 leading-relaxed">{idea}</p>
            </div>
            <div className="grid grid-cols-2 gap-4 border-t border-border/5 pt-3">
              <div>
                ...
                <p className="text-foreground/80 font-semibold">{stable}</p>
              </div>
              <div>
                <span className="font-bold text-foreground uppercase tracking-wider text-[10px] text-muted-foreground block mb-1">
                  In-place Memory
                </span>
                <p className="text-foreground/80 font-semibold">{inplace}</p>
              </div>
            </div>
            {reference && (
