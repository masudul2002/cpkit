...
export function EducationalPanel({
  ...
  mistakes,
  cpTips,
  reference = "CP-Algorithms geometry reference",
        ...
        {activeTab === "info" && (
          <div className="space-y-4 text-xs text-left">
            ...
            <div>
              ...
              <div className="p-3 bg-muted/15 border border-border/10 rounded-lg font-mono text-[11px] text-emerald-500 overflow-x-auto">
                {formula}
              </div>
            </div>
            {reference && (
